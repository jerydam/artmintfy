    ...
    <main className="min-h-screen bg-[#050505] text-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-20 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
          <Link
            href="/mint"
            className="flex items-center justify-center gap-2 bg-white text-black px-8 py-4 rounded-2xl font-bold hover:bg-yellow-400 transition-all transform hover:scale-105"
          >
            Start Minting <ArrowRight size={20} />
          </Link>
          <Link
            href="/all-address"
            className="flex items-center justify-center gap-2 bg-slate-900 border border-slate-800 px-8 py-4 rounded-2xl font-bold hover:bg-slate-800 transition-all"
          >
